...
class BrainGroq:
    ...
    def _prompt_default(self) -> str:
        ...
        return (
            ...
            "dividir pantalla, etc.).\n"
            "- Para ubicar una ventana en una MITAD del monitor (izquierda/"
            "derecha/arriba/abajo) usá posicionar_ventana; para partir la "
            "pantalla con DOS apps (una a cada lado) usá dividir_pantalla. "
            "Para mover a OTRO monitor, mover_ventana.\n"
