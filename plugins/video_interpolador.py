...
class VideoInterpolador(Plugin):
    ...
    def manejar_tool(self, nombre_tool: str, args: Dict[str, Any],
        ...
        if nombre_tool == "interpolar_video":
            ...
            if ruta_elegida:
                ...
                return self._lanzar(str(ruta_elegida), cfg["bat"], contexto)
    ...
    def interpolar_video(self, nombre: str = "",
        ...
        return self._lanzar(elegido, bat, contexto)
    ...
    def _lanzar(self, ruta_video: str, bat: str,
        ...
        Un hilo aparte espera a que termine y avisa por voz/consola.
        """
    ...
    def _correr_pipeline(self, ruta_video: str, bat: str, nombre_video: str,
        ...
        if codigo == 0:
            ...
            self._notificar(
                f"La interpolación de {nombre_video} terminó con error "
                f"(código {codigo}).", contexto)
